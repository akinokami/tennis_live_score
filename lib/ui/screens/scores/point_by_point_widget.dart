                      ...
                      child: ListView.builder(
                        //physics: const NeverScrollableScrollPhysics(),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if((pbpData?[pbpData.length -
                                (index + 1)]
                                .points
                                ?.length??0)>6){
                              firstData = pbpData?[pbpData.length -
                                  (index + 1)]
                                  .points?.take(6).toList();
                              print("zzzzzzx ${firstData?.length}");
                              secondData= pbpData?[pbpData.length -
                                  (index + 1)]
                                  .points?.skip(6).toList();
                            }else{
                              normalData=pbpData?[pbpData.length -
                                  (index + 1)]
                                  .points;
                            }
                            return Container(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CustomText(
                                          fontSize: 8.sp,
                                          text: pbpData?[pbpData.length - (index + 1)]
                                                  .score?[0]
                                                  .toString() ??
                                              ""),
                                      kSizedBoxW30,
                                     if ((normalData?.length??0)>0) SizedBox(
                                          height: 15.h,
                                          child: ListView.builder(
                                              scrollDirection: Axis.horizontal,
                                              shrinkWrap: true,
                                      ...
                                      if ((firstData?.length??0)>0) Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
